...
{
    /* Initialize USART */
    PLIB_USART_BaudRateSet(USART_ID_4, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 115000);
...
{
    /* Initialize USART */
    PLIB_USART_BaudRateSet(USART_ID_3, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 115000);
